    ...
    <CaseStudyShell>
      <main>
        ...
        <header className="container cs-header">
          ...
          <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "var(--warn-dim)", border: "1px solid rgba(245, 168, 117, 0.3)", padding: "4px 12px", fontFamily: "var(--font-mono)", fontSize: "10px", color: "var(--warn)", borderRadius: "9999px", marginBottom: "18px" }}>
            <span style={{ color: "var(--warn)", fontSize: "8px" }}>●</span>
